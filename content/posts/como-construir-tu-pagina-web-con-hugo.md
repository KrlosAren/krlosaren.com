...
Para eso llegó [Hugo](https://gohugo.io/).
...
Siempre recomiendo comenzar por el [getting started oficial](https://gohugo.io/getting-started/). Instalar Hugo es sencillo, viene con lo básico para arrancar, incluye un servidor local con hot reload y una configuración clara en un archivo `hugo.toml`.

Una vez instalado, lo siguiente es elegir un tema. Hay muchas opciones en [themes.gohugo.io](https://themes.gohugo.io/) —minimalistas, enfocados en blogs, en portfolios, en documentación. Elige uno que se acerque a lo que quieres y personalízalo desde ahí.
...
Y lo mejor: cuando estés listo, puedes desplegarlo gratis en [GitHub Pages](https://pages.github.com/).
